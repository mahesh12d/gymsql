...
## Recent Changes
- **October 4, 2025**: Profile page visualization updates - (1) Removed "Your Speed" line chart from Progress Charts section, (2) Implemented Calendar Heatmap Chart using ECharts to visualize daily problem-solving activity with color-coded intensity based on problems solved per day, (3) Removed Topic Progress section to streamline the profile page, (4) Removed Recommendations section including learning path suggestions and recommended problems to simplify the user experience.
